...
For tool-agnostic DDL/load skeletons of all three structures (hub, link,
satellite), the business-key checklist, and a PIT-table helper, see
[DATA-VAULT-TEMPLATE.md](./DATA-VAULT-TEMPLATE.md). Substitute your engine's
syntax and hash function (consult `docs/agents/platform.md` if present).
